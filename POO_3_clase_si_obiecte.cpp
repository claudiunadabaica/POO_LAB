...
using namespace std; // pentru biblioteci cu functii standard, cunoscute din C++
...
int main()
{
	...
	//	Specific Visual C++ / CLI
		//Console::WriteLine(p1.vs + "\t" + p1.nume + "\t" + p1.prenume); 
		// eroare pe 		pointerul d caractere
		for (int i = 0; i < nr_persoane; i++) {
